  ...
  return (
    <div className="min-h-screen bg-surface dark:bg-slate-900 text-on-background dark:text-slate-100 font-body">
      ...
      <main id="main-content" className="max-w-4xl mx-auto px-6 pt-32 pb-24">
        <h1 className="text-4xl font-headline font-bold text-primary dark:text-slate-100 mb-8">Politika privatnosti</h1>
        <div className="prose prose-lg text-on-surface-variant dark:text-slate-400 space-y-6">
