      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {service.problems.map((problem) => (
            <div
              key={problem.title}
              className="bg-surface-container-lowest p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow flex items-center space-x-6"
            >
              ...
              <div>
                <h4 className="font-bold text-primary text-lg font-headline">
                  {problem.title}
                </h4>
