    ...
    <section className="py-24 bg-surface dark:bg-slate-900">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        <div className="order-2 md:order-1">
          ...
          <h2 className="font-headline text-4xl font-bold text-primary dark:text-slate-100 mb-6 leading-tight">
            Tehnička podrška na koju se možete osloniti
          </h2>
          <div className="space-y-6 text-on-surface-variant dark:text-slate-400 text-lg leading-relaxed">
            <p>
          ...
          <div className="mt-10 grid grid-cols-2 gap-8">
            {stats.map((s) => (
              <div key={s.label} className="border-l-4 border-secondary pl-4">
                <div className="text-3xl font-headline font-bold text-primary dark:text-slate-100">
                  {s.value}
                </div>
        ...
        <div className="order-1 md:order-2 relative">
          <div className="aspect-[4/5] rounded-xl overflow-hidden shadow-2xl">
            <img
              src="images/pexels-bulat843-1243575272-34054468.webp"
